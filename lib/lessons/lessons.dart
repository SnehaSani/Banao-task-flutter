...
class _LessonsState extends State<Lessons> {
  ...
  Future<void> fetchData() async {
    final response= await RemoteService.fetchData('https://632017e19f82827dcf24a655.mockapi.io/api/lessons');
    if(response!=null){
      setState(() {
        lessons=response;
      });
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('${lesson['name']}',style: TextStyle(color: Color(0xff598BED),fontWeight: FontWeight.w600,fontSize: 16),),
                                SizedBox(height: 8,),
                                Text('Duration: ${lesson['duration']}',style: TextStyle(color: Color(0xff598BED),fontSize: 14),),
                                SizedBox(height: 3,),
                                Text('Category: ${lesson['category']}',style: TextStyle(color: Color(0xff598BED),fontSize: 14),),
                                SizedBox(height: 3,),
                                Text('Locked: ${lesson['locked']}',style: TextStyle(color: Color(0xff598BED),fontSize: 14),),
                              ],
                            ),
                          ),
                        ],
